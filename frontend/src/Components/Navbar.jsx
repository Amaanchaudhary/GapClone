        ...
        <div id='navbar-screen'>
            <div className='navbar-1'>
                ...
                <div className='nav-1-right'>
                    <div className='nav-1-right-left'>
                        ...
                        <div>
                            <p>Free Shipping on $50+ for Rewards Members SIGN IN OR JOIN DETAILS</p>
                        </div>
                    </div>
                    <div className='nav-1-right-right'>
                        <div>
                            <p className='sign-in-p'>Sign In <br/><span>YOUR ACCOUNT</span></p>
                        </div>
                        <button><i class="fa-solid fa-bag-shopping fa-2xl"></i></button>
                    </div>
                </div>
            </div>
            ...
            <div className='navbar-3'>
                ...
                <div className='nav3-right'>
                    <p>Applied at checkout. Excludes brand collaborations. <u>Details</u></p>
                </div>
            </div>
        </div>
    )
